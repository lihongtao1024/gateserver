...
func (proto *KeepAliveReq) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, uint16(102)) {
		return false
	}
...
func (proto *PlayerAppearNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Name, 255) {
		return false
	}
...
func (proto *PlayerAppearNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Name, 255) {
		return false
	}
...
func (proto *NPCAppearNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Dir) {
		return false
	}
...
func (proto *NPCAppearNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Dir) {
		return false
	}
...
func (proto *ObjMoveNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Dst_x) {
		return false
	}

	if !writeProtoInteger(b, proto.Dst_y) {
		return false
	}
...
func (proto *ObjMoveNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Dst_x) {
		return false
	}

	if !readProtoInteger(b, &proto.Dst_y) {
		return false
	}
...
func (proto *MoveReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Cur_x) {
		return false
	}

	if !writeProtoInteger(b, proto.Cur_y) {
		return false
	}

	if !writeProtoInteger(b, proto.Idx) {
		return false
	}
...
func (proto *MoveReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Cur_x) {
		return false
	}

	if !readProtoInteger(b, &proto.Cur_y) {
		return false
	}

	if !readProtoInteger(b, &proto.Idx) {
		return false
	}
...
func (proto *AddJumpMapRegionNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustom(b, &proto.Jump_region) {
		return false
	}
...
func (proto *AddJumpMapRegionNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Jump_region) {
		return false
	}
...
func (proto *ItemDestroyNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Item_guids, uint16(65535)) {
		return false
	}
...
func (proto *ItemDestroyNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Item_guids, uint16(65535)) {
		return false
	}
...
func (proto *TopMsgNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Foreground) {
		return false
	}

	if !writeProtoInteger(b, proto.Background) {
		return false
	}
...
func (proto *TopMsgNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Foreground) {
		return false
	}

	if !readProtoInteger(b, &proto.Background) {
		return false
	}
...
func (proto *SubmitForm) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Form, 255) {
		return false
	}

	if !writeProtoString(b, proto.Func, 255) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Args, uint8(255)) {
		return false
	}
...
func (proto *SubmitForm) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Form, 255) {
		return false
	}

	if !readProtoString(b, &proto.Func, 255) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Args, uint8(255)) {
		return false
	}
...
func (proto *ShowFormNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Compressed) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Context, uint16(65535)) {
		return false
	}
...
func (proto *ShowFormNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Compressed) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Context, uint16(65535)) {
		return false
	}
...
func (proto *ExecuteGMReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Cmd, 255) {
		return false
	}

	if !writeProtoString(b, proto.Arg, 255) {
		return false
	}
...
func (proto *ExecuteGMReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Cmd, 255) {
		return false
	}

	if !readProtoString(b, &proto.Arg, 255) {
		return false
	}
...
func (proto *FightBeginNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustomArray(b, proto.Groups, uint8(255)) {
		return false
	}

	if !writeProtoInteger(b, proto.Self_group) {
		return false
	}

	if !writeProtoInteger(b, proto.Is_pvp) {
		return false
	}
...
func (proto *FightBeginNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Groups, uint8(255)) {
		return false
	}

	if !readProtoInteger(b, &proto.Self_group) {
		return false
	}

	if !readProtoInteger(b, &proto.Is_pvp) {
		return false
	}
...
func (proto *TurnRoundNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Round) {
		return false
	}
...
func (proto *TurnRoundNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Round) {
		return false
	}
...
func (proto *FightOperateListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Player_operates, uint8(255)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Pet_operates, uint8(255)) {
		return false
	}

	if !writeProtoInteger(b, proto.Count_down) {
		return false
	}
...
func (proto *FightOperateListNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Player_operates, uint8(255)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Pet_operates, uint8(255)) {
		return false
	}

	if !readProtoInteger(b, &proto.Count_down) {
		return false
	}
...
func (proto *FightOperateReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustom(b, &proto.Operate) {
		return false
	}
...
func (proto *FightOperateReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Operate) {
		return false
	}
...
func (proto *FightDisplayNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Data, uint32(4294967295)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Crypto, uint8(255)) {
		return false
	}
...
func (proto *FightDisplayNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Data, uint32(4294967295)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Crypto, uint8(255)) {
		return false
	}
...
func (proto *FightAutoReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Is_auto) {
		return false
	}
...
func (proto *FightAutoReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Is_auto) {
		return false
	}
...
func (proto *FightAutoSkillReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Skillid) {
		return false
	}
...
func (proto *FightAutoSkillReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Skillid) {
		return false
	}
...
func (proto *FightEndNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Result) {
		return false
	}
...
func (proto *FightEndNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Result) {
		return false
	}
...
func (proto *AddFighterNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Group) {
		return false
	}
...
func (proto *AddFighterNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Group) {
		return false
	}
...
func (proto *TeamLeaderOprReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Opr) {
		return false
	}
...
func (proto *TeamLeaderOprReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Opr) {
		return false
	}
...
func (proto *TeamNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Leader_guards, uint8(255)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Members, uint8(255)) {
		return false
	}
...
func (proto *TeamNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Leader_guards, uint8(255)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Members, uint8(255)) {
		return false
	}
...
func (proto *NpcSelectReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Npc_guid) {
		return false
	}

	if !writeProtoInteger(b, proto.Select_id) {
		return false
	}
...
func (proto *NpcSelectReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Npc_guid) {
		return false
	}

	if !readProtoInteger(b, &proto.Select_id) {
		return false
	}
...
func (proto *NpcSelectAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustomArray(b, proto.Options, uint16(65535)) {
		return false
	}

	if !writeProtoString(b, proto.Msg, 4096) {
		return false
	}
...
func (proto *NpcSelectAck) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Options, uint16(65535)) {
		return false
	}

	if !readProtoString(b, &proto.Msg, 4096) {
		return false
	}
...
func (proto *NpcTalkReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Talk, uint16(65535)) {
		return false
	}
...
func (proto *NpcTalkReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Talk, uint16(65535)) {
		return false
	}
...
func (proto *InviteMsgNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Inviter_guid) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Interval) {
		return false
	}
...
func (proto *InviteMsgNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Inviter_guid) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Interval) {
		return false
	}
...
func (proto *ReplyInvite) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Agreed) {
		return false
	}
...
func (proto *ReplyInvite) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Agreed) {
		return false
	}
...
func (proto *AddSkillNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustom(b, &proto.Skill) {
		return false
	}
...
func (proto *AddSkillNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Skill) {
		return false
	}
...
func (proto *PetContainerNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(72)) {
		return false
	}
...
func (proto *PetContainerUpdateNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(73)) {
		return false
	}
...
func (proto *PetAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(74)) {
		return false
	}
...
func (proto *PetDestroyNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(75)) {
		return false
	}
...
func (proto *SetPetLineup) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(76)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Lineup) {
		return false
	}
...
func (proto *SetPetLineup) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Lineup) {
		return false
	}
...
func (proto *ShowPet) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(77)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Show) {
		return false
	}
...
func (proto *ShowPet) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Show) {
		return false
	}
...
func (proto *ReleasePet) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(78)) {
		return false
	}
...
func (proto *MovePet) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(79)) {
		return false
	}
...
func (proto *ShopOpenNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(80)) {
		return false
	}

	if !writeProtoInteger(b, proto.Shop_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Def_item_id) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Shop_item_list, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Buy_back_list, uint16(65535)) {
		return false
	}
...
func (proto *ShopOpenNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Shop_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Def_item_id) {
		return false
	}
	...
	if !readProtoCustomArray(b, &proto.Shop_item_list, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Buy_back_list, uint16(65535)) {
		return false
	}
...
func (proto *ShopBuyNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(81)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Shop_item_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Shop_item_num) {
		return false
	}
...
func (proto *ShopBuyNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Shop_item_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Shop_item_num) {
		return false
	}
...
func (proto *SellNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(82)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Sell_items, uint16(65535)) {
		return false
	}
...
func (proto *SellNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Sell_items, uint16(65535)) {
		return false
	}
...
func (proto *BuyBackNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(83)) {
		return false
	}

	if !writeProtoInteger(b, proto.Buy_guid) {
		return false
	}
...
func (proto *BuyBackNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Buy_guid) {
		return false
	}
...
func (proto *BuyBackListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(84)) {
		return false
	}
...
func (proto *TeamAttrNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(85)) {
		return false
	}
...
func (proto *TipsMsgExNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(86)) {
		return false
	}
...
func (proto *ItemNewAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(87)) {
		return false
	}
...
func (proto *QuestContainerNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(88)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Buffer, uint16(65535)) {
		return false
	}
...
func (proto *QuestContainerNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Buffer, uint16(65535)) {
		return false
	}
...
func (proto *QuestAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(89)) {
		return false
	}
...
func (proto *QuestStateNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(90)) {
		return false
	}
...
func (proto *QuestNpcStateNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(91)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Logo) {
		return false
	}
...
func (proto *QuestNpcStateNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Logo) {
		return false
	}
...
func (proto *QuestTrackCountNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(92)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Track_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Track_count) {
		return false
	}
...
func (proto *QuestTrackCountNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Track_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Track_count) {
		return false
	}
...
func (proto *QuestTalkSelectReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(93)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Option_id) {
		return false
	}
...
func (proto *QuestTalkSelectReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Option_id) {
		return false
	}
...
func (proto *QuestTalkSelectAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(94)) {
		return false
	}
...
func (proto *ObjStrCustomNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(95)) {
		return false
	}
...
func (proto *ObjIntCustomNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(96)) {
		return false
	}
...
func (proto *ObjDynAttrNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(97)) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Dyn_attr) {
		return false
	}
...
func (proto *ObjDynAttrNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Dyn_attr) {
		return false
	}
...
func (proto *CommitQuestItemRsp) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(98)) {
		return false
	}
...
func (proto *CommitQuestItemNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(99)) {
		return false
	}
...
func (proto *CommitQuestPetRsp) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(100)) {
		return false
	}
...
func (proto *SkillTipsReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(103)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Skill_id) {
		return false
	}
...
func (proto *SkillTipsReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Skill_id) {
		return false
	}
...
func (proto *SkillTipsAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustomArray(b, proto.Tips, uint8(255)) {
		return false
	}
...
func (proto *SkillTipsAck) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Tips, uint8(255)) {
		return false
	}
...
func (proto *KeepAliveCtrlNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(106)) {
		return false
	}

	if !writeProtoInteger(b, proto.Opt) {
		return false
	}
...
func (proto *KeepAliveCtrlNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Opt) {
		return false
	}
...
func (proto *NetDelayReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(107)) {
		return false
	}

	if !writeProtoInteger(b, proto.Gs_tick) {
		return false
	}

	if !writeProtoInteger(b, proto.Gt_tick) {
		return false
	}

	if !writeProtoInteger(b, proto.Sg_tick) {
		return false
	}

	if !writeProtoInteger(b, proto.Ping) {
		return false
	}
...
func (proto *NetDelayReq) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Gs_tick) {
		return false
	}

	if !readProtoInteger(b, &proto.Gt_tick) {
		return false
	}

	if !readProtoInteger(b, &proto.Sg_tick) {
		return false
	}

	if !readProtoInteger(b, &proto.Ping) {
		return false
	}
...
func (proto *NetDelayAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(108)) {
		return false
	}

	if !writeProtoInteger(b, proto.Gs_elpase) {
		return false
	}

	if !writeProtoInteger(b, proto.Gt_elpase) {
		return false
	}

	if !writeProtoInteger(b, proto.Sg_elpase) {
		return false
	}

	if !writeProtoInteger(b, proto.Gt_cpu) {
		return false
	}

	if !writeProtoInteger(b, proto.Baidu_delay) {
		return false
	}

	if !writeProtoInteger(b, proto.Taobao_delay) {
		return false
	}

	if !writeProtoString(b, proto.Sg_id, 255) {
		return false
	}
...
func (proto *NetDelayAck) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Gs_elpase) {
		return false
	}

	if !readProtoInteger(b, &proto.Gt_elpase) {
		return false
	}

	if !readProtoInteger(b, &proto.Sg_elpase) {
		return false
	}

	if !readProtoInteger(b, &proto.Gt_cpu) {
		return false
	}

	if !readProtoInteger(b, &proto.Baidu_delay) {
		return false
	}

	if !readProtoInteger(b, &proto.Taobao_delay) {
		return false
	}

	if !readProtoString(b, &proto.Sg_id, 255) {
		return false
	}
...
func (proto *SystemSetupNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(109)) {
		return false
	}
...
func (proto *BuffListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(110)) {
		return false
	}
...
func (proto *BuffAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(111)) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Buff) {
		return false
	}
...
func (proto *BuffAddNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Buff) {
		return false
	}
...
func (proto *BuffDurationNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(112)) {
		return false
	}
...
func (proto *BuffDynAttrNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(113)) {
		return false
	}
...
func (proto *StopBuff) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(114)) {
		return false
	}
...
func (proto *BuffDelNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(115)) {
		return false
	}
...
func (proto *ActivityListReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(116)) {
		return false
	}
...
func (proto *ActivityListAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(117)) {
		return false
	}
...
func (proto *ActivityJoinNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(118)) {
		return false
	}
...
func (proto *GuildListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(119)) {
		return false
	}

	if !writeProtoInteger(b, proto.Pos) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Guilds, uint16(65535)) {
		return false
	}
...
func (proto *GuildListNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Pos) {
		return false
	}
	...
	if !readProtoCustomArray(b, &proto.Guilds, uint16(65535)) {
		return false
	}
...
func (proto *GuildNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(120)) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Self) {
		return false
	}
...
func (proto *GuildNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Self) {
		return false
	}
...
func (proto *GuildBaseNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(121)) {
		return false
	}
...
func (proto *GuildNoticeNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(122)) {
		return false
	}
...
func (proto *GuildBriefNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(123)) {
		return false
	}
...
func (proto *GuildMemberListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(124)) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Members, uint16(65535)) {
		return false
	}
...
func (proto *GuildMemberListNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Members, uint16(65535)) {
		return false
	}
...
func (proto *GuildMemberNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(125)) {
		return false
	}
...
func (proto *GuildApplicantListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(126)) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Applicants, uint16(65535)) {
		return false
	}
...
func (proto *GuildApplicantListNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Applicants, uint16(65535)) {
		return false
	}
...
func (proto *GuildOperationNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(127)) {
		return false
	}
	...
	if !writeProtoString(b, proto.Param1, 255) {
		return false
	}

	if !writeProtoString(b, proto.Param2, 255) {
		return false
	}
...
func (proto *GuildOperationNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Param1, 255) {
		return false
	}

	if !readProtoString(b, &proto.Param2, 255) {
		return false
	}
...
func (proto *GetTimestampReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(128)) {
		return false
	}
...
func (proto *GetTimestampAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(129)) {
		return false
	}
...
func (proto *ContactListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(130)) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Contacts, uint16(65535)) {
		return false
	}
...
func (proto *ContactListNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Contacts, uint16(65535)) {
		return false
	}
...
func (proto *AddContactNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(131)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Contact) {
		return false
	}
...
func (proto *AddContactNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Contact) {
		return false
	}
...
func (proto *UpdateContactNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(132)) {
		return false
	}
...
func (proto *DelContactNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(133)) {
		return false
	}
...
func (proto *AddContactMessageNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(134)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Messages) {
		return false
	}
...
func (proto *AddContactMessageNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Messages) {
		return false
	}
...
func (proto *ItemQueryNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(135)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Item) {
		return false
	}
...
func (proto *ItemQueryNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Item) {
		return false
	}
...
func (proto *PetQueryNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(136)) {
		return false
	}
...
func (proto *ContactInfoNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(137)) {
		return false
	}
...
func (proto *MailListNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(138)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Mails, uint8(255)) {
		return false
	}
...
func (proto *MailListNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Mails, uint8(255)) {
		return false
	}
...
func (proto *AddMailNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(139)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Mail) {
		return false
	}
...
func (proto *AddMailNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Mail) {
		return false
	}
...
func (proto *DelMailNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(140)) {
		return false
	}
...
func (proto *MailBodyNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(141)) {
		return false
	}
...
func (proto *UpdateMailBodyNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(142)) {
		return false
	}
...
func (proto *UpdateMailHeadNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(143)) {
		return false
	}
...
func (proto *RanklistReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(144)) {
		return false
	}
...
func (proto *RanklistAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(145)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Total) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Data, uint16(65535)) {
		return false
	}
...
func (proto *RanklistAck) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Total) {
		return false
	}
	...
	if !readProtoCustomArray(b, &proto.Data, uint16(65535)) {
		return false
	}
...
func (proto *GetRankReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(146)) {
		return false
	}
...
func (proto *GetRankAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(147)) {
		return false
	}
...
func (proto *TitleContainerNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(148)) {
		return false
	}
...
func (proto *TitleAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(149)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Title) {
		return false
	}
...
func (proto *TitleAddNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Title) {
		return false
	}
...
func (proto *TitleDelNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(150)) {
		return false
	}
...
func (proto *AgentKeyReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(151)) {
		return false
	}
...
func (proto *AgentKeyAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(152)) {
		return false
	}
...
func (proto *HeadMsgNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(153)) {
		return false
	}
...
func (proto *AutoContainerNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(154)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Auto_skill) {
		return false
	}
...
func (proto *AutoContainerNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Auto_skill) {
		return false
	}
...
func (proto *PlayerQueryNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(155)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Brief) {
		return false
	}
...
func (proto *PlayerQueryNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Brief) {
		return false
	}
...
func (proto *UseAllItem) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(156)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Item_amount) {
		return false
	}
...
func (proto *UseAllItem) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Item_amount) {
		return false
	}
...
func (proto *GuardContainerNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(157)) {
		return false
	}
...
func (proto *GuardAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(158)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Guard) {
		return false
	}
...
func (proto *GuardAddNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Guard) {
		return false
	}
...
func (proto *SetGuardLineup) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(159)) {
		return false
	}
...
func (proto *PetNewAddNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(160)) {
		return false
	}
...
func (proto *TeamPlatformNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(161)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Teams, uint16(65535)) {
		return false
	}
...
func (proto *TeamPlatformNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Teams, uint16(65535)) {
		return false
	}
...
func (proto *TeamApplicantsNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(162)) {
		return false
	}
...
func (proto *TeamOperationNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(163)) {
		return false
	}
...
func (proto *TeamTargetNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(164)) {
		return false
	}
...
func (proto *ChangedNameNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(165)) {
		return false
	}
...
func (proto *CustomDataNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(166)) {
		return false
	}
...
func (proto *SpeedCheckNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(167)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Pct) {
		return false
	}
...
func (proto *SpeedCheckNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Pct) {
		return false
	}
...
func (proto *ConsoleMsgNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(168)) {
		return false
	}
...
func (proto *PetSwapNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(169)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Pet_guid1) {
		return false
	}

	if !writeProtoInteger(b, proto.Pet_guid2) {
		return false
	}
...
func (proto *PetSwapNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Pet_guid1) {
		return false
	}

	if !readProtoInteger(b, &proto.Pet_guid2) {
		return false
	}
...
func (proto *GuardDestroyNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(170)) {
		return false
	}
...
func (proto *ActivateGuard) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(171)) {
		return false
	}

	if !writeProtoInteger(b, proto.Guard_id) {
		return false
	}
...
func (proto *ActivateGuard) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Guard_id) {
		return false
	}
...
func (proto *ReleaseGuard) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(172)) {
		return false
	}

	if !writeProtoInteger(b, proto.Guard_guid) {
		return false
	}
...
func (proto *ReleaseGuard) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Guard_guid) {
		return false
	}
...
func (proto *TeamMemberSwapNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(173)) {
		return false
	}

	if !writeProtoInteger(b, proto.Member_guid1) {
		return false
	}

	if !writeProtoInteger(b, proto.Member_guid2) {
		return false
	}
...
func (proto *TeamMemberSwapNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Member_guid1) {
		return false
	}

	if !readProtoInteger(b, &proto.Member_guid2) {
		return false
	}
...
func (proto *GuardSwapNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(174)) {
		return false
	}

	if !writeProtoInteger(b, proto.Guard_guid1) {
		return false
	}

	if !writeProtoInteger(b, proto.Guard_guid2) {
		return false
	}
...
func (proto *GuardSwapNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Guard_guid1) {
		return false
	}

	if !readProtoInteger(b, &proto.Guard_guid2) {
		return false
	}
...
func (proto *PetReplaceNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(175)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Dst_pet_guid) {
		return false
	}

	if !writeProtoCustom(b, &proto.Src_pet) {
		return false
	}
...
func (proto *PetReplaceNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Dst_pet_guid) {
		return false
	}

	if !readProtoCustom(b, &proto.Src_pet) {
		return false
	}
...
func (proto *GuardAppearNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(176)) {
		return false
	}
...
func (proto *InstructionContainerNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(177)) {
		return false
	}

	if !writeProtoCustom(b, &proto.Datas) {
		return false
	}
...
func (proto *InstructionContainerNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Datas) {
		return false
	}
...
func (proto *InstructionAddReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(178)) {
		return false
	}
...
func (proto *InstructionAddAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(179)) {
		return false
	}
...
func (proto *InstructionDeleteReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(180)) {
		return false
	}
...
func (proto *InstructionDeleteAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(181)) {
		return false
	}
...
func (proto *InstructionModfityReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(182)) {
		return false
	}
...
func (proto *InstructionModifyAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(183)) {
		return false
	}
...
func (proto *InstructionDefaultReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(184)) {
		return false
	}
...
func (proto *InstructionDefaultAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(185)) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Datas, uint8(255)) {
		return false
	}
...
func (proto *InstructionDefaultAck) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Datas, uint8(255)) {
		return false
	}
...
func (proto *InstructionAttachReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(186)) {
		return false
	}
...
func (proto *InstructionAttachAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(187)) {
		return false
	}
...
func (proto *InstructionAttachNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(188)) {
		return false
	}
...
func (proto *InstructionDetachReq) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(189)) {
		return false
	}
...
func (proto *InstructionDetachAck) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(190)) {
		return false
	}
...
func (proto *InstructionDetachNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(191)) {
		return false
	}
...
func (proto *PlayerDetailNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(192)) {
		return false
	}
...
func (proto *MapDynBlockPtNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(193)) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Block_pt_list, uint16(65535)) {
		return false
	}
...
func (proto *MapDynBlockPtNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Block_pt_list, uint16(65535)) {
		return false
	}
...
func (proto *GuardQueryNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(194)) {
		return false
	}
...
func (proto *BuyBackNtfEx) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(195)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Buy_amount) {
		return false
	}
...
func (proto *BuyBackNtfEx) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Buy_amount) {
		return false
	}
...
func (proto *GuildCustomNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(196)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Is_guild) {
		return false
	}
...
func (proto *GuildCustomNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Is_guild) {
		return false
	}
...
func (proto *PreTurnRoundNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(197)) {
		return false
	}
...
func (proto *FighterSpecialPetNtf) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, uint16(198)) {
		return false
	}

	if !writeProtoInteger(b, proto.Special_pet) {
		return false
	}
...
func (proto *FighterSpecialPetNtf) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Special_pet) {
		return false
	}
