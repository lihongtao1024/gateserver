...
func (proto *CustomStrData) Write(b *bytes.Buffer) bool {
	if !writeProtoIntegerArray(b, proto.Key, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Value, uint32(4294967295)) {
		return false
	}
...
func (proto *CustomStrData) Read(b *bytes.Buffer) bool {
	if !readProtoIntegerArray(b, &proto.Key, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Value, uint32(4294967295)) {
		return false
	}
...
func (proto *CustomIntData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Value) {
		return false
	}
...
func (proto *CustomIntData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Value) {
		return false
	}
...
func (proto *CustomData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Strdata, uint32(4294967295)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Intdata, uint32(4294967295)) {
		return false
	}
...
func (proto *CustomData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Strdata, uint32(4294967295)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Intdata, uint32(4294967295)) {
		return false
	}
...
func (proto *SkillData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Id) {
		return false
	}

	if !writeProtoInteger(b, proto.Performance) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_performance) {
		return false
	}

	if !writeProtoInteger(b, proto.Tick) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Bind) {
		return false
	}
...
func (proto *SkillData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Id) {
		return false
	}

	if !readProtoInteger(b, &proto.Performance) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_performance) {
		return false
	}

	if !readProtoInteger(b, &proto.Tick) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Bind) {
		return false
	}
...
func (proto *DynAttrData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Mark) {
		return false
	}

	if !writeProtoInteger(b, proto.Attr) {
		return false
	}
...
func (proto *DynAttrData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Mark) {
		return false
	}

	if !readProtoInteger(b, &proto.Attr) {
		return false
	}
...
func (proto *BuffData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Buff_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Start_times) {
		return false
	}

	if !writeProtoInteger(b, proto.Duration) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Dyn_attrs, uint16(65535)) {
		return false
	}
...
func (proto *BuffData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Buff_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Start_times) {
		return false
	}

	if !readProtoInteger(b, &proto.Duration) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Dyn_attrs, uint16(65535)) {
		return false
	}
...
func (proto *QuestData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Quest_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Quest_state) {
		return false
	}

	if !writeProtoInteger(b, proto.Accept_npc) {
		return false
	}

	if !writeProtoInteger(b, proto.Commit_npc) {
		return false
	}

	if !writeProtoInteger(b, proto.Quest_store_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Accpet_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Limit_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Changed_time) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Ext, uint16(65535)) {
		return false
	}
...
func (proto *QuestData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Quest_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Quest_state) {
		return false
	}

	if !readProtoInteger(b, &proto.Accept_npc) {
		return false
	}

	if !readProtoInteger(b, &proto.Commit_npc) {
		return false
	}

	if !readProtoInteger(b, &proto.Quest_store_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Accpet_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Limit_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Changed_time) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Ext, uint16(65535)) {
		return false
	}
...
func (proto *QuestRingData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Quest_ring) {
		return false
	}
...
func (proto *QuestRingData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Quest_ring) {
		return false
	}
...
func (proto *QuestStoreData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Ring_auto) {
		return false
	}

	if !writeProtoInteger(b, proto.Ring_day) {
		return false
	}

	if !writeProtoInteger(b, proto.Ring_week) {
		return false
	}

	if !writeProtoInteger(b, proto.Ring_display) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Quest_rings, uint16(65535)) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_reset_day) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_reset_week) {
		return false
	}
...
func (proto *QuestStoreData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Ring_auto) {
		return false
	}

	if !readProtoInteger(b, &proto.Ring_day) {
		return false
	}

	if !readProtoInteger(b, &proto.Ring_week) {
		return false
	}

	if !readProtoInteger(b, &proto.Ring_display) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Quest_rings, uint16(65535)) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_reset_day) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_reset_week) {
		return false
	}
...
func (proto *QuestCountData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Count) {
		return false
	}
...
func (proto *QuestCountData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Count) {
		return false
	}
...
func (proto *QuestContainerData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Quests, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Npc_visible, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Npc_invisible, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Stores, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Abandoned, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Finished, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Activated, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Failed_counts, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Finished_counts, uint16(65535)) {
		return false
	}
...
func (proto *QuestContainerData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Quests, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Npc_visible, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Npc_invisible, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Stores, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Abandoned, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Finished, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Activated, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Failed_counts, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Finished_counts, uint16(65535)) {
		return false
	}
...
func (proto *ItemData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Role) {
		return false
	}

	if !writeProtoInteger(b, proto.Site) {
		return false
	}

	if !writeProtoInteger(b, proto.Battlesite) {
		return false
	}

	if !writeProtoInteger(b, proto.Amount) {
		return false
	}

	if !writeProtoInteger(b, proto.Isbound) {
		return false
	}

	if !writeProtoInteger(b, proto.Life) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Customs) {
		return false
	}
...
func (proto *ItemData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Role) {
		return false
	}

	if !readProtoInteger(b, &proto.Site) {
		return false
	}

	if !readProtoInteger(b, &proto.Battlesite) {
		return false
	}

	if !readProtoInteger(b, &proto.Amount) {
		return false
	}

	if !readProtoInteger(b, &proto.Isbound) {
		return false
	}

	if !readProtoInteger(b, &proto.Life) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Customs) {
		return false
	}
...
func (proto *ItemContainerData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Container_type) {
		return false
	}

	if !writeProtoInteger(b, proto.Capacity) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Items, uint16(65535)) {
		return false
	}
...
func (proto *ItemContainerData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Container_type) {
		return false
	}

	if !readProtoInteger(b, &proto.Capacity) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Items, uint16(65535)) {
		return false
	}
...
func (proto *UserData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Uname, 32) {
		return false
	}

	if !writeProtoInteger(b, proto.Billinyb) {
		return false
	}

	if !writeProtoInteger(b, proto.Billoutyb) {
		return false
	}

	if !writeProtoInteger(b, proto.Gameinyb) {
		return false
	}

	if !writeProtoInteger(b, proto.Gameoutyb) {
		return false
	}

	if !writeProtoInteger(b, proto.Createtime) {
		return false
	}

	if !writeProtoInteger(b, proto.Lastlogin) {
		return false
	}
...
func (proto *UserData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Uname, 32) {
		return false
	}

	if !readProtoInteger(b, &proto.Billinyb) {
		return false
	}

	if !readProtoInteger(b, &proto.Billoutyb) {
		return false
	}

	if !readProtoInteger(b, &proto.Gameinyb) {
		return false
	}

	if !readProtoInteger(b, &proto.Gameoutyb) {
		return false
	}

	if !readProtoInteger(b, &proto.Createtime) {
		return false
	}

	if !readProtoInteger(b, &proto.Lastlogin) {
		return false
	}
...
func (proto *SceneData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Map_guid) {
		return false
	}

	if !writeProtoInteger(b, proto.X) {
		return false
	}

	if !writeProtoInteger(b, proto.Y) {
		return false
	}
...
func (proto *SceneData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Map_guid) {
		return false
	}

	if !readProtoInteger(b, &proto.X) {
		return false
	}

	if !readProtoInteger(b, &proto.Y) {
		return false
	}
...
func (proto *TicketData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Create_time) {
		return false
	}
...
func (proto *TicketData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Create_time) {
		return false
	}
...
func (proto *PetData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Name, 32) {
		return false
	}

	if !writeProtoCustom(b, &proto.Equips) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Attrs, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Extra_attrs, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Skills, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Buffs, uint16(65535)) {
		return false
	}
...
func (proto *PetData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Name, 32) {
		return false
	}

	if !readProtoCustom(b, &proto.Equips) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Attrs, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Extra_attrs, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Skills, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Buffs, uint16(65535)) {
		return false
	}
...
func (proto *PetContainerData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustomArray(b, proto.Pets, uint16(65535)) {
		return false
	}
...
func (proto *PetContainerData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Pets, uint16(65535)) {
		return false
	}
...
func (proto *TitleData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Title_id) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Custom) {
		return false
	}
...
func (proto *TitleData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Title_id) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Custom) {
		return false
	}
...
func (proto *TitleContainerData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Titles, uint16(65535)) {
		return false
	}
...
func (proto *TitleContainerData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Titles, uint16(65535)) {
		return false
	}
...
func (proto *SeatBasic) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Score) {
		return false
	}
...
func (proto *SeatBasic) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Score) {
		return false
	}
...
func (proto *SeatData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Seats, uint8(255)) {
		return false
	}
...
func (proto *SeatData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Seats, uint8(255)) {
		return false
	}
...
func (proto *LineupBasic) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Seat_id) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Lineup, uint8(255)) {
		return false
	}
...
func (proto *LineupBasic) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Seat_id) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Lineup, uint8(255)) {
		return false
	}
...
func (proto *LineupData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustomArray(b, proto.Lineups, uint8(255)) {
		return false
	}
...
func (proto *LineupData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Lineups, uint8(255)) {
		return false
	}
...
func (proto *InstructionBasic) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Content, 32) {
		return false
	}
...
func (proto *InstructionBasic) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Content, 32) {
		return false
	}
...
func (proto *InstructionData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Frienddata, uint8(255)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Enemydata, uint8(255)) {
		return false
	}
...
func (proto *InstructionData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Frienddata, uint8(255)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Enemydata, uint8(255)) {
		return false
	}
...
func (proto *EmojiData) Write(b *bytes.Buffer) bool {
	if !writeProtoIntegerArray(b, proto.Emojis, uint32(4294967295)) {
		return false
	}
...
func (proto *EmojiData) Read(b *bytes.Buffer) bool {
	if !readProtoIntegerArray(b, &proto.Emojis, uint32(4294967295)) {
		return false
	}
...
func (proto *PlayerBrief) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Unid, 32) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Map) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.State) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Destroytime) {
		return false
	}
...
func (proto *PlayerBrief) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Unid, 32) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Map) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.State) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Destroytime) {
		return false
	}
...
func (proto *GuardContainerData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Guards, uint16(65535)) {
		return false
	}
...
func (proto *GuardContainerData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Guards, uint16(65535)) {
		return false
	}
...
func (proto *PlayerData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Lastloginip) {
		return false
	}

	if !writeProtoInteger(b, proto.Lastlogout) {
		return false
	}

	if !writeProtoInteger(b, proto.Onlines) {
		return false
	}

	if !writeProtoCustom(b, &proto.Cur_map) {
		return false
	}

	if !writeProtoCustom(b, &proto.Last_common_map) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Items, uint8(255)) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Quests) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Guards) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Tickets, uint16(65535)) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Titles) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Lineups) {
		return false
	}

	if !writeProtoCustom(b, &proto.Seats) {
		return false
	}

	if !writeProtoCustom(b, &proto.Instructions) {
		return false
	}

	if !writeProtoCustom(b, &proto.Pet_lineups) {
		return false
	}
...
func (proto *PlayerData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Lastloginip) {
		return false
	}

	if !readProtoInteger(b, &proto.Lastlogout) {
		return false
	}

	if !readProtoInteger(b, &proto.Onlines) {
		return false
	}

	if !readProtoCustom(b, &proto.Cur_map) {
		return false
	}

	if !readProtoCustom(b, &proto.Last_common_map) {
		return false
	}
	...
	if !readProtoCustomArray(b, &proto.Items, uint8(255)) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Quests) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Guards) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Tickets, uint16(65535)) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Titles) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Lineups) {
		return false
	}

	if !readProtoCustom(b, &proto.Seats) {
		return false
	}

	if !readProtoCustom(b, &proto.Instructions) {
		return false
	}

	if !readProtoCustom(b, &proto.Pet_lineups) {
		return false
	}
...
func (proto *MapRegion) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Min_x) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_x) {
		return false
	}

	if !writeProtoInteger(b, proto.Min_y) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_y) {
		return false
	}
...
func (proto *MapRegion) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Min_x) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_x) {
		return false
	}

	if !readProtoInteger(b, &proto.Min_y) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_y) {
		return false
	}
...
func (proto *ItemAttrValue64) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Attr_type) {
		return false
	}

	if !writeProtoInteger(b, proto.Attr_value) {
		return false
	}
...
func (proto *ItemAttrValue64) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Attr_type) {
		return false
	}

	if !readProtoInteger(b, &proto.Attr_value) {
		return false
	}
...
func (proto *ItemAttrValueS) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Attr_value, uint16(65535)) {
		return false
	}
...
func (proto *ItemAttrValueS) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Attr_value, uint16(65535)) {
		return false
	}
...
func (proto *ItemAttrValueS64) Write(b *bytes.Buffer) bool {
	if !writeProtoString(b, proto.Attr_key, 255) {
		return false
	}
...
func (proto *ItemAttrValueS64) Read(b *bytes.Buffer) bool {
	if !readProtoString(b, &proto.Attr_key, 255) {
		return false
	}
...
func (proto *ItemAttrValueList) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Item_guid) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Item_values_64, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Item_values_s, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Item_values_s64, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Item_values_ss, uint16(65535)) {
		return false
	}
...
func (proto *ItemAttrValueList) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Item_guid) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Item_values_64, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Item_values_s, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Item_values_s64, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Item_values_ss, uint16(65535)) {
		return false
	}
...
func (proto *ChatMsg) Write(b *bytes.Buffer) bool {
	if !writeProtoString(b, proto.Role_name, 255) {
		return false
	}

	if !writeProtoInteger(b, proto.Role_id) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Message, uint16(65535)) {
		return false
	}

	if !writeProtoInteger(b, proto.Vip) {
		return false
	}
...
func (proto *ChatMsg) Read(b *bytes.Buffer) bool {
	if !readProtoString(b, &proto.Role_name, 255) {
		return false
	}

	if !readProtoInteger(b, &proto.Role_id) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Message, uint16(65535)) {
		return false
	}

	if !readProtoInteger(b, &proto.Vip) {
		return false
	}
...
func (proto *ParamData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Param, uint16(65535)) {
		return false
	}
...
func (proto *ParamData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Param, uint16(65535)) {
		return false
	}
...
func (proto *FightBuffData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Stack) {
		return false
	}
...
func (proto *FightBuffData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Stack) {
		return false
	}
...
func (proto *FighterData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Fighter_id) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Template_id) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Pets, uint8(255)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Buffs, uint8(255)) {
		return false
	}

	if !writeProtoInteger(b, proto.Model) {
		return false
	}

	if !writeProtoString(b, proto.Friend_instruction, 32) {
		return false
	}

	if !writeProtoString(b, proto.Enemy_instruction, 32) {
		return false
	}
...
func (proto *FighterData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Fighter_id) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Template_id) {
		return false
	}
	...
	if !readProtoCustomArray(b, &proto.Pets, uint8(255)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Buffs, uint8(255)) {
		return false
	}

	if !readProtoInteger(b, &proto.Model) {
		return false
	}

	if !readProtoString(b, &proto.Friend_instruction, 32) {
		return false
	}

	if !readProtoString(b, &proto.Enemy_instruction, 32) {
		return false
	}
...
func (proto *FightGroupData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Lineup_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Lineup_lv) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Fighters, uint8(255)) {
		return false
	}
...
func (proto *FightGroupData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Lineup_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Lineup_lv) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Fighters, uint8(255)) {
		return false
	}
...
func (proto *FightOperateData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Actor) {
		return false
	}

	if !writeProtoInteger(b, proto.Operate) {
		return false
	}

	if !writeProtoInteger(b, proto.Target) {
		return false
	}

	if !writeProtoInteger(b, proto.Param) {
		return false
	}
...
func (proto *FightOperateData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Actor) {
		return false
	}

	if !readProtoInteger(b, &proto.Operate) {
		return false
	}

	if !readProtoInteger(b, &proto.Target) {
		return false
	}

	if !readProtoInteger(b, &proto.Param) {
		return false
	}
...
func (proto *MemberData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Temp_leave) {
		return false
	}
...
func (proto *MemberData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Temp_leave) {
		return false
	}
...
func (proto *KeyValueU32) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Key) {
		return false
	}
...
func (proto *KeyValueU32) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Key) {
		return false
	}
...
func (proto *KeyValueS) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Value, 255) {
		return false
	}
...
func (proto *KeyValueS) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Value, 255) {
		return false
	}
...
func (proto *OptionData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Text, 255) {
		return false
	}
...
func (proto *OptionData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Text, 255) {
		return false
	}
...
func (proto *ShopItemData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Price_type) {
		return false
	}

	if !writeProtoInteger(b, proto.Price) {
		return false
	}
...
func (proto *ShopItemData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Price_type) {
		return false
	}

	if !readProtoInteger(b, &proto.Price) {
		return false
	}
...
func (proto *Col1Data) Write(b *bytes.Buffer) bool {
	if !writeProtoString(b, proto.Col1, 255) {
		return false
	}
...
func (proto *Col1Data) Read(b *bytes.Buffer) bool {
	if !readProtoString(b, &proto.Col1, 255) {
		return false
	}
...
func (proto *Col2Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col2, 255) {
		return false
	}
...
func (proto *Col2Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col2, 255) {
		return false
	}
...
func (proto *Col3Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col3, 255) {
		return false
	}
...
func (proto *Col3Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col3, 255) {
		return false
	}
...
func (proto *Col4Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col4, 255) {
		return false
	}
...
func (proto *Col4Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col4, 255) {
		return false
	}
...
func (proto *Col5Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col5, 255) {
		return false
	}
...
func (proto *Col5Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col5, 255) {
		return false
	}
...
func (proto *Col6Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col6, 255) {
		return false
	}
...
func (proto *Col6Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col6, 255) {
		return false
	}
...
func (proto *Col7Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col7, 255) {
		return false
	}
...
func (proto *Col7Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col7, 255) {
		return false
	}
...
func (proto *Col8Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col8, 255) {
		return false
	}
...
func (proto *Col8Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col8, 255) {
		return false
	}
...
func (proto *Col9Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col9, 255) {
		return false
	}
...
func (proto *Col9Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col9, 255) {
		return false
	}
...
func (proto *Col10Data) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Col10, 255) {
		return false
	}
...
func (proto *Col10Data) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Col10, 255) {
		return false
	}
...
func (proto *TalkNodeData) Write(b *bytes.Buffer) bool {
	if !writeProtoString(b, proto.Node_type, 255) {
		return false
	}

	if !writeProtoString(b, proto.Node_id, 255) {
		return false
	}

	if !writeProtoString(b, proto.Display_text, 255) {
		return false
	}

	if !writeProtoString(b, proto.Connect_text, 255) {
		return false
	}

	if !writeProtoString(b, proto.Npc_id, 255) {
		return false
	}

	if !writeProtoString(b, proto.Npc_emotion, 255) {
		return false
	}

	if !writeProtoString(b, proto.Npc_talk, 512) {
		return false
	}

	if !writeProtoString(b, proto.Npc_template, 255) {
		return false
	}

	if !writeProtoString(b, proto.Func_type, 255) {
		return false
	}

	if !writeProtoString(b, proto.Link_node, 255) {
		return false
	}

	if !writeProtoString(b, proto.Belong_to, 255) {
		return false
	}

	if !writeProtoString(b, proto.Player_talk, 255) {
		return false
	}
...
func (proto *TalkNodeData) Read(b *bytes.Buffer) bool {
	if !readProtoString(b, &proto.Node_type, 255) {
		return false
	}

	if !readProtoString(b, &proto.Node_id, 255) {
		return false
	}

	if !readProtoString(b, &proto.Display_text, 255) {
		return false
	}

	if !readProtoString(b, &proto.Connect_text, 255) {
		return false
	}

	if !readProtoString(b, &proto.Npc_id, 255) {
		return false
	}

	if !readProtoString(b, &proto.Npc_emotion, 255) {
		return false
	}

	if !readProtoString(b, &proto.Npc_talk, 512) {
		return false
	}

	if !readProtoString(b, &proto.Npc_template, 255) {
		return false
	}

	if !readProtoString(b, &proto.Func_type, 255) {
		return false
	}

	if !readProtoString(b, &proto.Link_node, 255) {
		return false
	}

	if !readProtoString(b, &proto.Belong_to, 255) {
		return false
	}

	if !readProtoString(b, &proto.Player_talk, 255) {
		return false
	}
...
func (proto *QuestClientData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Quest_type) {
		return false
	}

	if !writeProtoString(b, proto.Quest_type_name, 128) {
		return false
	}

	if !writeProtoString(b, proto.Quest_name, 32) {
		return false
	}

	if !writeProtoInteger(b, proto.Quest_color) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Display_location) {
		return false
	}

	if !writeProtoInteger(b, proto.Display_accept_tip) {
		return false
	}

	if !writeProtoInteger(b, proto.Display_accomplish_tip) {
		return false
	}

	if !writeProtoInteger(b, proto.Can_track) {
		return false
	}

	if !writeProtoInteger(b, proto.Can_abandon) {
		return false
	}
	...
	if !writeProtoString(b, proto.Accept_npc_info, 256) {
		return false
	}
	...
	if !writeProtoString(b, proto.Commit_npc_info, 256) {
		return false
	}

	if !writeProtoInteger(b, proto.Quest_goal_type) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Quest_goal, uint16(65535)) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Quest_award, uint16(65535)) {
		return false
	}

	if !writeProtoString(b, proto.Track_desc, 512) {
		return false
	}

	if !writeProtoString(b, proto.Cant_accept_track_desc, 512) {
		return false
	}

	if !writeProtoString(b, proto.Cant_accept_desc, 512) {
		return false
	}

	if !writeProtoString(b, proto.Can_accept_desc, 512) {
		return false
	}

	if !writeProtoString(b, proto.Accepted_desc, 512) {
		return false
	}

	if !writeProtoInteger(b, proto.Is_display_cycle_num) {
		return false
	}

	if !writeProtoInteger(b, proto.Finish_cycle_num) {
		return false
	}

	if !writeProtoInteger(b, proto.Total_cycle_num) {
		return false
	}
...
func (proto *QuestClientData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Quest_type) {
		return false
	}

	if !readProtoString(b, &proto.Quest_type_name, 128) {
		return false
	}

	if !readProtoString(b, &proto.Quest_name, 32) {
		return false
	}

	if !readProtoInteger(b, &proto.Quest_color) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Display_location) {
		return false
	}

	if !readProtoInteger(b, &proto.Display_accept_tip) {
		return false
	}

	if !readProtoInteger(b, &proto.Display_accomplish_tip) {
		return false
	}

	if !readProtoInteger(b, &proto.Can_track) {
		return false
	}

	if !readProtoInteger(b, &proto.Can_abandon) {
		return false
	}
	...
	if !readProtoString(b, &proto.Accept_npc_info, 256) {
		return false
	}
	...
	if !readProtoString(b, &proto.Commit_npc_info, 256) {
		return false
	}

	if !readProtoInteger(b, &proto.Quest_goal_type) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Quest_goal, uint16(65535)) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Quest_award, uint16(65535)) {
		return false
	}

	if !readProtoString(b, &proto.Track_desc, 512) {
		return false
	}

	if !readProtoString(b, &proto.Cant_accept_track_desc, 512) {
		return false
	}

	if !readProtoString(b, &proto.Cant_accept_desc, 512) {
		return false
	}

	if !readProtoString(b, &proto.Can_accept_desc, 512) {
		return false
	}

	if !readProtoString(b, &proto.Accepted_desc, 512) {
		return false
	}

	if !readProtoInteger(b, &proto.Is_display_cycle_num) {
		return false
	}

	if !readProtoInteger(b, &proto.Finish_cycle_num) {
		return false
	}

	if !readProtoInteger(b, &proto.Total_cycle_num) {
		return false
	}
...
func (proto *QuestTalkData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Npc_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Node_id) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Talk_text, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Options, uint8(255)) {
		return false
	}
...
func (proto *QuestTalkData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Npc_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Node_id) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Talk_text, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Options, uint8(255)) {
		return false
	}
...
func (proto *SkillTipsData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Name) {
		return false
	}
...
func (proto *SkillTipsData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Name) {
		return false
	}
...
func (proto *GoalKillBossData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Boss_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Map_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Loc_x) {
		return false
	}

	if !writeProtoInteger(b, proto.Loc_y) {
		return false
	}

	if !writeProtoInteger(b, proto.Kill_count) {
		return false
	}
...
func (proto *GoalKillBossData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Boss_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Map_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Loc_x) {
		return false
	}

	if !readProtoInteger(b, &proto.Loc_y) {
		return false
	}

	if !readProtoInteger(b, &proto.Kill_count) {
		return false
	}
...
func (proto *GoalCommitItemData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Item_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Item_count) {
		return false
	}
...
func (proto *GoalCommitItemData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Item_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Item_count) {
		return false
	}
...
func (proto *GoalCommitPetData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Pet_id) {
		return false
	}

	if !writeProtoInteger(b, proto.Pet_count) {
		return false
	}
...
func (proto *GoalCommitPetData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Pet_id) {
		return false
	}

	if !readProtoInteger(b, &proto.Pet_count) {
		return false
	}
...
func (proto *GoalArriveAddrData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Range) {
		return false
	}
...
func (proto *GoalArriveAddrData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Range) {
		return false
	}
...
func (proto *GoalFightMapData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Count_required) {
		return false
	}
...
func (proto *GoalFightMapData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Count_required) {
		return false
	}
...
func (proto *GoalFightMapCountData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Fight_map, uint8(255)) {
		return false
	}
...
func (proto *GoalFightMapCountData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Fight_map, uint8(255)) {
		return false
	}
...
func (proto *GoalKillMonsterData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Monster_id) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Left) {
		return false
	}

	if !writeProtoInteger(b, proto.Top) {
		return false
	}

	if !writeProtoInteger(b, proto.Width) {
		return false
	}

	if !writeProtoInteger(b, proto.Height) {
		return false
	}
...
func (proto *GoalKillMonsterData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Monster_id) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Left) {
		return false
	}

	if !readProtoInteger(b, &proto.Top) {
		return false
	}

	if !readProtoInteger(b, &proto.Width) {
		return false
	}

	if !readProtoInteger(b, &proto.Height) {
		return false
	}
...
func (proto *GoalKillMonsterCountData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustomArray(b, proto.Kill_monster, uint8(255)) {
		return false
	}
...
func (proto *GoalKillMonsterCountData) Read(b *bytes.Buffer) bool {
	if !readProtoCustomArray(b, &proto.Kill_monster, uint8(255)) {
		return false
	}
...
func (proto *GoalEncounterFightData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Cur_num) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_num) {
		return false
	}
...
func (proto *GoalEncounterFightData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Cur_num) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_num) {
		return false
	}
...
func (proto *GoalPVEData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Win_cur) {
		return false
	}

	if !writeProtoInteger(b, proto.Win_required) {
		return false
	}
...
func (proto *GoalPVEData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Win_cur) {
		return false
	}

	if !readProtoInteger(b, &proto.Win_required) {
		return false
	}
...
func (proto *IPConfig) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Port) {
		return false
	}

	if !writeProtoInteger(b, proto.Recv_buf) {
		return false
	}

	if !writeProtoInteger(b, proto.Send_buf) {
		return false
	}

	if !writeProtoString(b, proto.Ip, 255) {
		return false
	}
...
func (proto *IPConfig) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Port) {
		return false
	}

	if !readProtoInteger(b, &proto.Recv_buf) {
		return false
	}

	if !readProtoInteger(b, &proto.Send_buf) {
		return false
	}

	if !readProtoString(b, &proto.Ip, 255) {
		return false
	}
...
func (proto *ActivityData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Today) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Custom, uint16(65535)) {
		return false
	}
...
func (proto *ActivityData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Today) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Custom, uint16(65535)) {
		return false
	}
...
func (proto *StringData) Write(b *bytes.Buffer) bool {
	if !writeProtoIntegerArray(b, proto.Str, uint16(65535)) {
		return false
	}
...
func (proto *StringData) Read(b *bytes.Buffer) bool {
	if !readProtoIntegerArray(b, &proto.Str, uint16(65535)) {
		return false
	}
...
func (proto *AuctionObjectData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Custom1) {
		return false
	}

	if !writeProtoInteger(b, proto.Custom2) {
		return false
	}

	if !writeProtoInteger(b, proto.Custom3) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Fight_value) {
		return false
	}

	if !writeProtoInteger(b, proto.Coin_type) {
		return false
	}

	if !writeProtoInteger(b, proto.Coin_value) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Puton_times) {
		return false
	}

	if !writeProtoInteger(b, proto.Pulloff_times) {
		return false
	}

	if !writeProtoInteger(b, proto.Seller_guid) {
		return false
	}

	if !writeProtoString(b, proto.Seller_name, 32) {
		return false
	}

	if !writeProtoCustom(b, &proto.Item_data) {
		return false
	}

	if !writeProtoCustom(b, &proto.Pet_data) {
		return false
	}
...
func (proto *AuctionObjectData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Custom1) {
		return false
	}

	if !readProtoInteger(b, &proto.Custom2) {
		return false
	}

	if !readProtoInteger(b, &proto.Custom3) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Fight_value) {
		return false
	}

	if !readProtoInteger(b, &proto.Coin_type) {
		return false
	}

	if !readProtoInteger(b, &proto.Coin_value) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Puton_times) {
		return false
	}

	if !readProtoInteger(b, &proto.Pulloff_times) {
		return false
	}

	if !readProtoInteger(b, &proto.Seller_guid) {
		return false
	}

	if !readProtoString(b, &proto.Seller_name, 32) {
		return false
	}

	if !readProtoCustom(b, &proto.Item_data) {
		return false
	}

	if !readProtoCustom(b, &proto.Pet_data) {
		return false
	}
...
func (proto *AuctionCookieData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustomArray(b, proto.Coins, uint16(65535)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Favorites, uint8(255)) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Records, uint8(255)) {
		return false
	}
...
func (proto *AuctionCookieData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustomArray(b, &proto.Coins, uint16(65535)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Favorites, uint8(255)) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Records, uint8(255)) {
		return false
	}
...
func (proto *GuildMemberBriefData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Player_name, 32) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Guild_job) {
		return false
	}

	if !writeProtoInteger(b, proto.Total_contrb) {
		return false
	}

	if !writeProtoInteger(b, proto.Join_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_login_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_logout_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Status) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Reincarnation) {
		return false
	}

	if !writeProtoInteger(b, proto.Job) {
		return false
	}
...
func (proto *GuildMemberBriefData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Player_name, 32) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Guild_job) {
		return false
	}

	if !readProtoInteger(b, &proto.Total_contrb) {
		return false
	}

	if !readProtoInteger(b, &proto.Join_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_login_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_logout_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Status) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Reincarnation) {
		return false
	}

	if !readProtoInteger(b, &proto.Job) {
		return false
	}
...
func (proto *GuildMemberData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Surplus_contrb) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_week_contrb) {
		return false
	}

	if !writeProtoInteger(b, proto.This_week_contrb) {
		return false
	}

	if !writeProtoInteger(b, proto.Permission) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Donate_bind_gold) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_donate_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_dividend_time) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Forbid_end_time) {
		return false
	}
...
func (proto *GuildMemberData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Surplus_contrb) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_week_contrb) {
		return false
	}

	if !readProtoInteger(b, &proto.This_week_contrb) {
		return false
	}

	if !readProtoInteger(b, &proto.Permission) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Donate_bind_gold) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_donate_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_dividend_time) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Forbid_end_time) {
		return false
	}
...
func (proto *GuildApplicantData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Sn) {
		return false
	}

	if !writeProtoInteger(b, proto.Guild_contrb) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_apply_time) {
		return false
	}
...
func (proto *GuildApplicantData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Sn) {
		return false
	}

	if !readProtoInteger(b, &proto.Guild_contrb) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_apply_time) {
		return false
	}
...
func (proto *GuildEventData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Event_type) {
		return false
	}

	if !writeProtoInteger(b, proto.Event_time) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Event_msg, uint16(65535)) {
		return false
	}
...
func (proto *GuildEventData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Event_type) {
		return false
	}

	if !readProtoInteger(b, &proto.Event_time) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Event_msg, uint16(65535)) {
		return false
	}
...
func (proto *GuildBriefData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Guild_id) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Leader_guid) {
		return false
	}

	if !writeProtoString(b, proto.Leader_name, 32) {
		return false
	}

	if !writeProtoInteger(b, proto.Leader_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Leader_role) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Member_count) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_member_count) {
		return false
	}

	if !writeProtoString(b, proto.Declaration, 255) {
		return false
	}

	if !writeProtoInteger(b, proto.Applyed) {
		return false
	}

	if !writeProtoInteger(b, proto.Leader_school) {
		return false
	}
...
func (proto *GuildBriefData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Guild_id) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Leader_guid) {
		return false
	}

	if !readProtoString(b, &proto.Leader_name, 32) {
		return false
	}

	if !readProtoInteger(b, &proto.Leader_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Leader_role) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Member_count) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_member_count) {
		return false
	}

	if !readProtoString(b, &proto.Declaration, 255) {
		return false
	}

	if !readProtoInteger(b, &proto.Applyed) {
		return false
	}

	if !readProtoInteger(b, &proto.Leader_school) {
		return false
	}
...
func (proto *GuildData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Base_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Wing_room_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Vault_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Academy_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Pharmacy_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Upgrade_cooldown) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Online_count) {
		return false
	}

	if !writeProtoInteger(b, proto.Fund) {
		return false
	}

	if !writeProtoInteger(b, proto.Liveness) {
		return false
	}

	if !writeProtoInteger(b, proto.Build_degree) {
		return false
	}

	if !writeProtoInteger(b, proto.Prestige) {
		return false
	}

	if !writeProtoInteger(b, proto.Fight_score) {
		return false
	}

	if !writeProtoInteger(b, proto.Config) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Dismissed_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Impeach_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Impeach_guid) {
		return false
	}
	...
	if !writeProtoCustomArray(b, proto.Events, uint16(65535)) {
		return false
	}
...
func (proto *GuildData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Base_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Wing_room_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Vault_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Academy_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Pharmacy_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Upgrade_cooldown) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Online_count) {
		return false
	}

	if !readProtoInteger(b, &proto.Fund) {
		return false
	}

	if !readProtoInteger(b, &proto.Liveness) {
		return false
	}

	if !readProtoInteger(b, &proto.Build_degree) {
		return false
	}

	if !readProtoInteger(b, &proto.Prestige) {
		return false
	}

	if !readProtoInteger(b, &proto.Fight_score) {
		return false
	}

	if !readProtoInteger(b, &proto.Config) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Dismissed_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Impeach_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Impeach_guid) {
		return false
	}
	...
	if !readProtoCustomArray(b, &proto.Events, uint16(65535)) {
		return false
	}
...
func (proto *NoticeData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Notice_time) {
		return false
	}

	if !writeProtoString(b, proto.Notice, 1024) {
		return false
	}
...
func (proto *NoticeData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Notice_time) {
		return false
	}

	if !readProtoString(b, &proto.Notice, 1024) {
		return false
	}
...
func (proto *DBGuildData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoCustom(b, &proto.Notice) {
		return false
	}
...
func (proto *DBGuildData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoCustom(b, &proto.Notice) {
		return false
	}
...
func (proto *DBGuildMemberData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Total_fight_value) {
		return false
	}
...
func (proto *DBGuildMemberData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Total_fight_value) {
		return false
	}
...
func (proto *ContactData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Contact_type) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Friendship) {
		return false
	}

	if !writeProtoInteger(b, proto.Last_contact_time) {
		return false
	}
...
func (proto *ContactData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Contact_type) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Friendship) {
		return false
	}

	if !readProtoInteger(b, &proto.Last_contact_time) {
		return false
	}
...
func (proto *DBContactData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Contact_guid) {
		return false
	}
...
func (proto *DBContactData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Contact_guid) {
		return false
	}
...
func (proto *MessageData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Send_guid) {
		return false
	}

	if !writeProtoInteger(b, proto.Send_time) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Auto_reply) {
		return false
	}
...
func (proto *MessageData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Send_guid) {
		return false
	}

	if !readProtoInteger(b, &proto.Send_time) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Auto_reply) {
		return false
	}
...
func (proto *MailHeadData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Mail_type) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Title, uint8(255)) {
		return false
	}
	...
	if !writeProtoString(b, proto.Send_name, 32) {
		return false
	}
...
func (proto *MailHeadData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Mail_type) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Title, uint8(255)) {
		return false
	}
	...
	if !readProtoString(b, &proto.Send_name, 32) {
		return false
	}
...
func (proto *MailBodyData) Write(b *bytes.Buffer) bool {
	if !writeProtoIntegerArray(b, proto.Content, uint16(65535)) {
		return false
	}
...
func (proto *MailBodyData) Read(b *bytes.Buffer) bool {
	if !readProtoIntegerArray(b, &proto.Content, uint16(65535)) {
		return false
	}
...
func (proto *MailData) Write(b *bytes.Buffer) bool {
	if !writeProtoCustom(b, &proto.Head) {
		return false
	}

	if !writeProtoCustom(b, &proto.Body) {
		return false
	}
...
func (proto *MailData) Read(b *bytes.Buffer) bool {
	if !readProtoCustom(b, &proto.Head) {
		return false
	}

	if !readProtoCustom(b, &proto.Body) {
		return false
	}
...
func (proto *DBMailData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Guids, uint32(4294967295)) {
		return false
	}
...
func (proto *DBMailData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Guids, uint32(4294967295)) {
		return false
	}
...
func (proto *DBVarData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Value, uint16(65535)) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Merge_type) {
		return false
	}
...
func (proto *DBVarData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Value, uint16(65535)) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Merge_type) {
		return false
	}
...
func (proto *RanklistData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoString(b, proto.Rank_info, 255) {
		return false
	}

	if !writeProtoInteger(b, proto.Rank_data1) {
		return false
	}

	if !writeProtoInteger(b, proto.Rank_data2) {
		return false
	}

	if !writeProtoInteger(b, proto.Rank_data3) {
		return false
	}
...
func (proto *RanklistData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoString(b, &proto.Rank_info, 255) {
		return false
	}

	if !readProtoInteger(b, &proto.Rank_data1) {
		return false
	}

	if !readProtoInteger(b, &proto.Rank_data2) {
		return false
	}

	if !readProtoInteger(b, &proto.Rank_data3) {
		return false
	}
...
func (proto *DBRanklistData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Rank_guid) {
		return false
	}
...
func (proto *DBRanklistData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Rank_guid) {
		return false
	}
...
func (proto *TeamBriefData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Team_guid) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Min_require_level) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_require_level) {
		return false
	}
	...
	if !writeProtoCustom(b, &proto.Leader_data) {
		return false
	}

	if !writeProtoInteger(b, proto.Has_applicant) {
		return false
	}

	if !writeProtoInteger(b, proto.Min_require_reinc) {
		return false
	}

	if !writeProtoInteger(b, proto.Max_require_reinc) {
		return false
	}
...
func (proto *TeamBriefData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Team_guid) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Min_require_level) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_require_level) {
		return false
	}
	...
	if !readProtoCustom(b, &proto.Leader_data) {
		return false
	}

	if !readProtoInteger(b, &proto.Has_applicant) {
		return false
	}

	if !readProtoInteger(b, &proto.Min_require_reinc) {
		return false
	}

	if !readProtoInteger(b, &proto.Max_require_reinc) {
		return false
	}
...
func (proto *ExchangeData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Day) {
		return false
	}

	if !writeProtoCustomArray(b, proto.Records, uint16(65535)) {
		return false
	}
...
func (proto *ExchangeData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Day) {
		return false
	}

	if !readProtoCustomArray(b, &proto.Records, uint16(65535)) {
		return false
	}
...
func (proto *ForbidData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Keyword, uint8(255)) {
		return false
	}

	if !writeProtoInteger(b, proto.Keytype) {
		return false
	}

	if !writeProtoInteger(b, proto.Fbdtype) {
		return false
	}

	if !writeProtoInteger(b, proto.Begin) {
		return false
	}

	if !writeProtoInteger(b, proto.End) {
		return false
	}

	if !writeProtoIntegerArray(b, proto.Desc, uint8(255)) {
		return false
	}
...
func (proto *ForbidData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Keyword, uint8(255)) {
		return false
	}

	if !readProtoInteger(b, &proto.Keytype) {
		return false
	}

	if !readProtoInteger(b, &proto.Fbdtype) {
		return false
	}

	if !readProtoInteger(b, &proto.Begin) {
		return false
	}

	if !readProtoInteger(b, &proto.End) {
		return false
	}

	if !readProtoIntegerArray(b, &proto.Desc, uint8(255)) {
		return false
	}
...
func (proto *PasturePetData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Owner_guid) {
		return false
	}

	if !writeProtoCustom(b, &proto.Pet) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Placed_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Placed_status) {
		return false
	}

	if !writeProtoInteger(b, proto.Replaced_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Replaced_player_guid) {
		return false
	}

	if !writeProtoString(b, proto.Replaced_player_name, 32) {
		return false
	}

	if !writeProtoInteger(b, proto.Replaced_pet_guid) {
		return false
	}

	if !writeProtoString(b, proto.Replaced_pet_name, 32) {
		return false
	}
...
func (proto *PasturePetData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Owner_guid) {
		return false
	}

	if !readProtoCustom(b, &proto.Pet) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Placed_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Placed_status) {
		return false
	}

	if !readProtoInteger(b, &proto.Replaced_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Replaced_player_guid) {
		return false
	}

	if !readProtoString(b, &proto.Replaced_player_name, 32) {
		return false
	}

	if !readProtoInteger(b, &proto.Replaced_pet_guid) {
		return false
	}

	if !readProtoString(b, &proto.Replaced_pet_name, 32) {
		return false
	}
...
func (proto *LadderData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Rank) {
		return false
	}

	if !writeProtoCustom(b, &proto.Player) {
		return false
	}
...
func (proto *LadderData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Rank) {
		return false
	}

	if !readProtoCustom(b, &proto.Player) {
		return false
	}
...
func (proto *LadderRecordData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Action) {
		return false
	}

	if !writeProtoInteger(b, proto.Time) {
		return false
	}
	...
	if !writeProtoInteger(b, proto.Player_rank) {
		return false
	}
	...
	if !writeProtoString(b, proto.Target_name, 32) {
		return false
	}

	if !writeProtoInteger(b, proto.Target_rank) {
		return false
	}
...
func (proto *LadderRecordData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Action) {
		return false
	}

	if !readProtoInteger(b, &proto.Time) {
		return false
	}
	...
	if !readProtoInteger(b, &proto.Player_rank) {
		return false
	}
	...
	if !readProtoString(b, &proto.Target_name, 32) {
		return false
	}

	if !readProtoInteger(b, &proto.Target_rank) {
		return false
	}
...
func (proto *ViolateData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoIntegerArray(b, proto.Violate, uint8(255)) {
		return false
	}
...
func (proto *ViolateData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoIntegerArray(b, &proto.Violate, uint8(255)) {
		return false
	}
...
func (proto *ChannelSwitchData) Write(b *bytes.Buffer) bool {
	...
	if !writeProtoInteger(b, proto.Sw) {
		return false
	}
...
func (proto *ChannelSwitchData) Read(b *bytes.Buffer) bool {
	...
	if !readProtoInteger(b, &proto.Sw) {
		return false
	}
...
func (proto *VerifyData) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Fbd_time) {
		return false
	}

	if !writeProtoInteger(b, proto.Accountstatus) {
		return false
	}
...
func (proto *VerifyData) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Fbd_time) {
		return false
	}

	if !readProtoInteger(b, &proto.Accountstatus) {
		return false
	}
...
func (proto *IPPort) Write(b *bytes.Buffer) bool {
	if !writeProtoString(b, proto.Ip, 32) {
		return false
	}
...
func (proto *IPPort) Read(b *bytes.Buffer) bool {
	if !readProtoString(b, &proto.Ip, 32) {
		return false
	}
...
func (proto *CrossIPPort) Write(b *bytes.Buffer) bool {
	if !writeProtoInteger(b, proto.Gid) {
		return false
	}

	if !writeProtoInteger(b, proto.Gcp) {
		return false
	}

	if !writeProtoInteger(b, proto.Gsp) {
		return false
	}

	if !writeProtoString(b, proto.Innerip, 32) {
		return false
	}

	if !writeProtoString(b, proto.Extip, 32) {
		return false
	}

	if !writeProtoString(b, proto.Innerflag, 64) {
		return false
	}

	if !writeProtoString(b, proto.Clientname, 64) {
		return false
	}
...
func (proto *CrossIPPort) Read(b *bytes.Buffer) bool {
	if !readProtoInteger(b, &proto.Gid) {
		return false
	}

	if !readProtoInteger(b, &proto.Gcp) {
		return false
	}

	if !readProtoInteger(b, &proto.Gsp) {
		return false
	}

	if !readProtoString(b, &proto.Innerip, 32) {
		return false
	}

	if !readProtoString(b, &proto.Extip, 32) {
		return false
	}

	if !readProtoString(b, &proto.Innerflag, 64) {
		return false
	}

	if !readProtoString(b, &proto.Clientname, 64) {
		return false
	}
...
func (proto *TestJsonName) Write(b *bytes.Buffer) bool {
	if !writeProtoIntegerArray(b, proto.Name, uint16(65535)) {
		return false
	}
...
func (proto *TestJsonName) Read(b *bytes.Buffer) bool {
	if !readProtoIntegerArray(b, &proto.Name, uint16(65535)) {
		return false
	}
